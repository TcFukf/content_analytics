...
namespace social_analytics.Bl.TextAnalytics.TextAnalyzer.TextAnalyzer
{
    public class TextAnalyzer : ITextAnalyzer
    {
        ...
        public IEnumerable<double> TextSimilarity(string comparedText, params string[] text)
        {
            return TextSimilarity(comparedText,_tagScales,text);

        }
        public static IEnumerable<double> TextSimilarity(string comparedText, ITagScales scales, params string[] text)
        {
